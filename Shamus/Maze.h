...
#define XCOUNT 25//Размер игрового поля по горизонтали
#define YCOUNT 20//Размер игрового поля по вертикали
#define MAX_ROOM_X 8//Количество комнат по горизонтали
#define MAX_ROOM_Y 8//Количество комнат по вертикали
